...
public class Database {
    ...
    public float getTaskDesirability(int tasknum) {
        return taskList.get(tasknum).getDesirability();
    }
    ...
    public boolean getTaskFiller(int tasknum) {
        return taskList.get(tasknum).getFiller();
    }
    ...
    public void setTaskDuration(int tasknum, float time) {
        taskList.get(tasknum).setDuration(time);
    }

    public void setTaskDesirability(int tasknum, float time) {
        taskList.get(tasknum).setDesirability(time);
    }

    public void setTaskUrgency(int tasknum, Date dateTime) {
        taskList.get(tasknum).setUrgency(dateTime);
    }

    public void setTaskImportance(int tasknum, float value) {
        taskList.get(tasknum).setImportance(value);
    }

    public void setTaskFiller(int tasknum, boolean flag) {
        taskList.get(tasknum).setFiller(flag);
    }
    ...
    public ArrayList<Task> getSchedTasks(int schednum) {
        return schedList.get(schednum).getTasks();
    }
    ...
    public boolean isSchedTaskDayActive(int schednum, int tasknum, int day) {
        return schedList.get(schednum).isTaskDayActive(tasknum, day);
    }
    ...
    public void setSchedTaskDay(int schednum, int tasknum, int day) {
        schedList.get(schednum).setTaskDay(tasknum, day);
    }

    public void clearSchedTaskDay(int schednum, int tasknum, int day) {
        schedList.get(schednum).clearTaskDay(tasknum, day);
    }

    public void addTaskToSched(int schednum, int tasknum) {
        schedList.get(schednum).addTask(taskList.get(tasknum));
    }
